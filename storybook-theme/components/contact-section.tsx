    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold">Write a New Chapter</h2>
          <p className="text-muted-foreground">Share your story or start a new one together</p>
        </div>
        <form className="grid gap-6">
          ...
          <button className="w-full sm:w-auto px-6 py-3 rounded-md bg-primary text-primary-foreground">Submit</button>
        </form>
      </div>
    </section>
  );
