    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold">Broadcast Inquiry</h2>
          <p className="text-muted-foreground">Submit your message for the next scheduled segment.</p>
        </div>
        <form className="grid gap-6">
          ...
          <textarea rows={5} className="rounded-md border bg-background px-3 py-2 resize-none" placeholder="Message for broadcast..." />
