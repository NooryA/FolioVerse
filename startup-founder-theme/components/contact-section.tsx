    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Partnerships, collaboration, or product inquiries</p>
        </div>
        <form className="grid gap-6">
          ...
          <textarea rows={5} className="rounded-md border bg-background px-3 py-2 resize-none" placeholder="Tell me about your idea or opportunity..." />
